...
import { syncCartToBackend, syncCartFromBackend } from '@/lib/utils/cart-sync';
...
export default function LoginForm() {
    ...
    const onSubmit = async (data: any) => {
        try {
            ...
            // Store ONLY tokens (no user data in localStorage)
            ...
            // Show success toast
            authToast.loginSuccess(response.user.firstName);
